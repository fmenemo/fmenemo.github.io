...
const Footer: React.FC = () => {
  ...
  // The accessible names here are brands rather than words, so they are the
  // same in every edition and stay beside the icon they label rather than
  // sitting in the content module.
  const socialLinks = [
    { name: 'GitHub', href: contact.github, path: githubIcon },
    { name: 'LinkedIn', href: contact.linkedin, path: linkedinIcon },
  ];
