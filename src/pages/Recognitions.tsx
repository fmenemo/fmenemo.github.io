...
import { education, recognitions } from '../content';
...
const Recognitions: React.FC = () => (
  <Section id='recognitions' index='03' title='Recognitions'>
    ...
    <dl className='mt-12 grid gap-2 border-t border-rule pt-6 sm:grid-cols-4 sm:gap-8 dark:border-rule-dark'>
      <dt className={`${metaVoice} text-muted dark:text-muted-dark`}>Education</dt>
