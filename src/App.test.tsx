...
// Guard test for ticket 43 (the evidence as a record). The running head is the
...
// a second, different head on the same page. Read as source, because a deleted
// module is not a thing the rendered tree can be asked about.
describe('the section component the running head replaces', () => {
