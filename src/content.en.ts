      ...
      roles: [
        {
          ...
          bullets: [
            ...
            'Built semantic product matching on OpenSearch with k-NN vector similarity and BM25 text relevance, with a human-review dashboard in PayloadCMS for matches below the confidence threshold.',
            'Built the team’s agentic AI development workflow: orchestration and verification with role-based model routing, context budgeting and mandatory independent review, used for production delivery including security-critical work.',
            ...
            'Ran the API security audit and hardening programme for the public e-commerce service: eight findings across four vulnerability classes, closing SQL injection, broken access control, a write-side IDOR and a PII exposure; built the service’s first automated test harness and a security-regression tripwire in CI.',
