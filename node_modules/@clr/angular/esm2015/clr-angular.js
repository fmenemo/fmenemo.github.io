...
class DateIOService {
     ...
     * @return {?}
     */
    detectSeparator(date) {
        let /** @type {?} */ separatorUsed;
        for (const /** @type {?} */ separator of SEPARATORS) {
     ...
     * @return {?}
     */
    areDatePartsNumbers(dateParts) {
        for (const /** @type {?} */ part of dateParts) {
    ...
    isValidInput(date) {
        ...
        const /** @type {?} */ separator = this.detectSeparator(date);
        if (!separator) {
            return null;
        }
        const /** @type {?} */ dateParts = date.split(separator);
