...
var DateIOService = (function () {
    ...
    DateIOService.prototype.detectSeparator = function (date) {
        var separatorUsed;
        try {
    ...
    DateIOService.prototype.isNonNegativeNumber = function (num) {
        return NON_NEGATIVE_NUMBER.test(num);
    };
    DateIOService.prototype.areDatePartsNumbers = function (dateParts) {
        try {
            for (var dateParts_1 = __values(dateParts), dateParts_1_1 = dateParts_1.next(); !dateParts_1_1.done; dateParts_1_1 = dateParts_1.next()) {
                var part = dateParts_1_1.value;
            ...
            try {
                if (dateParts_1_1 && !dateParts_1_1.done && (_a = dateParts_1.return)) _a.call(dateParts_1);
            }
    ...
    DateIOService.prototype.isValidInput = function (date) {
        ...
        var separator = this.detectSeparator(date);
        if (!separator) {
            return null;
        }
    ...
    Selection.prototype.setSelected = function (item, selected) {
        switch (this._selectionType) {
            ...
            case SelectionType.Multi:
                ...
                var trackBy = this._items.trackBy;
                if (index >= 0 && !selected) {
